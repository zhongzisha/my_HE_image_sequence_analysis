...
def _create_vit(variant: str, pretrained: bool = False, **kwargs) -> VisionTransformer:
...
def vit_small_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        **kwargs)
    model = _create_vit('vit_small_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_base_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_vit('vit_base_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_large_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_vit('vit_large_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_huge_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_vit('vit_huge_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def vit_giant_patch14_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_vit('vit_giant_patch14_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
