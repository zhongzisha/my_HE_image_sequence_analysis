...
class PretrainVisionTransformerEncoder(nn.Module):
    ...
    def forward_features1(self, x, mask=None):
        x = self.patch_embed(x)
...
class PretrainVisionTransformer(nn.Module):
    ...
    def forward_features(self, x):
        x = self.encoder.forward_features1(x)
        return x
...
default_cfgs = generate_default_cfgs({
    'pretrain_videomae_small_patch16_224': _cfg(
        #url='https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_base_patch16_224_pt22k_ft22kto1k.pth',
        hf_hub_id='timm/'),
    'pretrain_videomae_base_patch16_224': _cfg(
        #url='https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_base_patch16_224_pt22k_ft22kto1k.pth',
        hf_hub_id='timm/'),
    'pretrain_videomae_large_patch16_224': _cfg(
        #url='https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_base_patch16_224_pt22k_ft22kto1k.pth',
        hf_hub_id='timm/'),
    'pretrain_videomae_huge_patch16_224': _cfg(
        #url='https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_base_patch16_224_pt22k_ft22kto1k.pth',
        hf_hub_id='timm/'),
    'pretrain_videomae_giant_patch16_224': _cfg(
        #url='https://conversationhub.blob.core.windows.net/beit-share-public/beit/beit_base_patch16_224_pt22k_ft22kto1k.pth',
        hf_hub_id='timm/'),
})
...
def _create_pretrain_videomae(variant: str, pretrained: bool = False, **kwargs) -> PretrainVisionTransformer:
...
def pretrain_videomae_small_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        **kwargs)
    model = _create_pretrain_videomae('pretrain_videomae_small_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def pretrain_videomae_base_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_pretrain_videomae('pretrain_videomae_base_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def pretrain_videomae_large_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_pretrain_videomae('pretrain_videomae_large_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def pretrain_videomae_huge_patch16_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_pretrain_videomae('pretrain_videomae_huge_patch16_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
...
def pretrain_videomae_giant_patch14_224(pretrained=False, **kwargs):
    model_args = dict(
        ...
        norm_layer=partial(nn.LayerNorm, eps=1e-6),
        **kwargs)
    model = _create_pretrain_videomae('pretrain_videomae_giant_patch14_224', pretrained=pretrained, **dict(model_args, **kwargs))
    return model
